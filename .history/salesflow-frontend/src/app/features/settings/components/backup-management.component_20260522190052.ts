        ...
        <div class="flex items-start justify-between gap-4">
          <div class="flex-1">
            <div class="flex items-center gap-3 mb-2">
              <ng-icon
                name="heroArchiveBox"
                class="text-2xl text-sf-primary flex-shrink-0"
              ></ng-icon>
          ...
          @for (backup of backups; track backup.backupId) {
            ...
            >
              <div class="flex-1">
                ...
                <div class="text-xs text-sf-muted flex items-center gap-2 flex-wrap">
                  ...
                  <span>•</span>
                  <span class="inline-flex items-center gap-1">
                    <ng-icon name="heroSquares2X2" class="text-sm"></ng-icon>
                    {{ Object.keys(backup.database.collections).length }}
                    مجموعات
                  </span>
                  <span>•</span>
                  <span class="inline-flex items-center gap-1">
                    <ng-icon name="heroDocument" class="text-sm"></ng-icon>
                    {{ backup.files.size }}
                  </span>
                </div>
              </div>
      ...
      >
        <div class="flex items-center gap-3">
          <ng-icon
            ...
            class="text-xl text-sf-primary flex-shrink-0"
          ></ng-icon>
          <h4 class="text-sm font-display font-bold text-sf-text">
            معلومات مهمة
          </h4>
